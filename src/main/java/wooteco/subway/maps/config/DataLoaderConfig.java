...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Line line1 = Line.of("신분당선", "red lighten-1", LocalTime.now(), LocalTime.now(), 10);
        Line line2 = Line.of("2호선", "green lighten-1", LocalTime.now(), LocalTime.now(), 10);
        Line line3 = Line.of("3호선", "orange darken-1", LocalTime.now(), LocalTime.now(), 10);
