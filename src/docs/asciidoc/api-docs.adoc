...
operation::paths/findPath[snippets='http-request,http-response,request-parameters,response-body,response-fields']

[[resources-paths-map]]
=== 노선도 찾기

operation::paths/findMap[snippets='http-response,response-body']
